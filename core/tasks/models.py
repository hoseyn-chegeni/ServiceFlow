...
class TaskStatusChange(models.Model):
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name="change_log")
    ...
    def __str__(self):
        return f"{self.changed_by} Set '{self.status}' for {self.task}"
...
class TaskPriorityChange(models.Model):
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name="priority_log"
    )
    ...
    def __str__(self):
        return f"{self.changed_by} Set '{self.priority}' for {self.task}"
