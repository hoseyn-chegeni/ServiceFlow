...
class Organization(models.Model):
    ...
    parent_organization = models.ForeignKey('self', on_delete=models.SET_NULL, blank= True, null=True, related_name='parent')
    ...
    created_by = models.ForeignKey('accounts.User',models.SET_NULL, blank=True, null=True )
