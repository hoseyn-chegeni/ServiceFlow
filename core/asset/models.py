...
class Asset(models.Model):
    ...
    assigned_user = models.ForeignKey('accounts.User', on_delete =models.SET_NULL, blank = True, null =True)
    status = models.ForeignKey('AsetStatus', on_delete = models.SET_NULL, blank = True, null = True)
    condition = models.ForeignKey('AssetCondition', on_delete = models.SET_NULL, blank = True, null = True)
